...
public class FormatSGMF {
    ...
    public FormatSGMF(boolean activo, String municipios, String noformato, String vereda, String noestacion, String ubicacionGeomorfoestructura, String ubicacionProvincia, String ubicacionRegion, String ubicacionUnidad, String ubicacionSubunidad, String ubicacionElemento, String nombreSGMF, String codigoSGMF, String observacionesSGMF, String ambiente0check, String ambiente1check, String ambiente2check, String ambiente3check, String ambiente4check, String ambiente5check, String ambiente6check, String ambiente7check, String ambiente8check) {
        ...
        this.ubicacionGeomorfoestructura = ubicacionGeomorfoestructura;
        this.ubicacionProvincia = ubicacionProvincia;
        this.ubicacionRegion = ubicacionRegion;
        this.ubicacionUnidad = ubicacionUnidad;
        this.ubicacionSubunidad = ubicacionSubunidad;
        this.ubicacionElemento = ubicacionElemento;
        this.nombreSGMF = nombreSGMF;
        this.codigoSGMF = codigoSGMF;
        this.observacionesSGMF = observacionesSGMF;
        this.ambiente0check = ambiente0check;
        this.ambiente1check = ambiente1check;
        this.ambiente2check = ambiente2check;
        this.ambiente3check = ambiente3check;
        this.ambiente4check = ambiente4check;
        this.ambiente5check = ambiente5check;
        this.ambiente6check = ambiente6check;
        this.ambiente7check = ambiente7check;
        this.ambiente8check = ambiente8check;
    }
}
